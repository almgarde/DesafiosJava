...
public class Pinball {
	...
	/** Points for each obstacle that is hit */
	private int pointsObstacle = 0;

	/** Total points scored for a ball */
	...
	/** Confirm or not if a player wants to play again */
	private String answerPlayer = "";

	/** Ball-type element */
	private Ball b;

	/** Green ball-type element */
	private GreenBall bv;

	/** Blue ball-type element */
	private BlueBall ba;
	...
	/**
	 * Calculates the total points according to the type of ball
	 */
